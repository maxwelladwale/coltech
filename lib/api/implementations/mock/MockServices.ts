...
export const mockMDVRs: IMDVRProduct[] = [
  {
    ...
    inStock: true,
    stockQuantity: 15,
    imageUrl: '/images/mdvr-4ch-ai.jpg',
  ...
  },
  {
    ...
    inStock: true,
    stockQuantity: 8,
    imageUrl: '/images/mdvr-8ch-ai.jpg',
    includesFreeLicense: true,
    licenseType: 'ai',
    licenseDurationMonths: 12,
    channels: 8,
  ...
  },
  {
    ...
    inStock: true,
    stockQuantity: 25,
    imageUrl: '/images/mdvr-4ch-std.jpg',
    includesFreeLicense: true,
    licenseType: 'non-ai',
    licenseDurationMonths: 12,
    channels: 4,
...
export const mockCameras: ICamera[] = [
  ...
  },
  {
    ...
    inStock: true,
    stockQuantity: 40,
    imageUrl: '/images/camera-interior.jpg',
    channels: 1,
    storageOptions: ['sd_card'],
    features: [
  ...
  },
  {
    ...
    inStock: true,
    stockQuantity: 30,
    imageUrl: '/images/camera-side-rear.jpg',
    channels: 2,
    storageOptions: ['sd_card'],
    features: [
      'Waterproof (IP68)',
